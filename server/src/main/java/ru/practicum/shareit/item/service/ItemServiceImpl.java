...
public class ItemServiceImpl implements ItemService {
    ...
    public ItemDto create(Long userId, ItemDto dto) {
        ...
        if (dto.getRequestId() != null) {
            item.setRequest(requestRepository.findById(dto.getRequestId())
                    .orElseThrow(() ->
                            new NotFoundException("Request with id=" + dto.getRequestId() + " not found")));
        }
    ...
    public ItemDto update(Long userId, Long itemId, ItemDto dto) {
        ...
        if (!item.getOwner().getId().equals(userId)) {
            throw new AccessException("User is not owner of item");
        }
    ...
    public ItemDto get(Long id) {
        ...
        dto.setComments(getComments(id));
    ...
    public List<ItemDto> getOwnerItems(Long userId) {
        ...
        List<Booking> bookings = itemIds.isEmpty()
                ? List.of()
